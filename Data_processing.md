...
Use [ASTRAL](https://github.com/smirarab/ASTRAL) to get species tree from gene trees. Gene trees obtained from the RAxML. `-i` input file, each gene tree on a separate line. To run ASTRAL you need to have Java.
```
